                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_news_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_news_name]" id="product_name_<?= $lang['languages_code']?>" onkeyup="pro_<?= $lang['languages_code']?>()"/>
...
<form action="" method="post" id="updateNews" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea class="longtxtNCP1 ckeditor" style="height:50px;display: block;" name="news_des"><?= $row_showMain['lang_news_des']?></textarea>
            <p class="titleRightNCP">Nội dung :</p>
