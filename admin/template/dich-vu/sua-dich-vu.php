                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_service_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_service_name]" id="product_name_<?= $lang['languages_code']?>" onkeyup="pro_<?= $lang['languages_code']?>()"/>
...
<form action="" method="post" id="updateService" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Mô tả ngắn:</p>
            <textarea class="longtxtNCP1 ckeditor" style="height:50px;" name="service_des"><?= $row_showMain['lang_service_des']?></textarea>
            <p class="titleRightNCP">Nội dung :</p>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    <p class="titleRightNCP" >Khai giảng</p>
                    <input type="text" class="txtNCP1" value="<?= $row['service_sub_infor1']?>" name="service_sub_infor1"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Lịch học</p>
                    <input type="text" class="txtNCP1" value="<?= $row['service_sub_infor2']?>" name="service_sub_infor2"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Học phí</p>
