...
<form action="" method="post" id="addService" enctype="multipart/form-data">
	...
	<div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea class="longtxtNCP1 ckeditor" style="height:50px;" name="service_des"></textarea>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="" name="service_sub_infor1"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Lịch học</p>
                    <input type="text" class="txtNCP1" value="" name="service_sub_infor2"/>
                </div>
                <div class="subColContent">
