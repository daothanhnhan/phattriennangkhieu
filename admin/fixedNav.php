    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <li><a href="index.php?page=dang-ky-online" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đăng ký Online</a>
            </li>

            <li><a href="index.php?page=dang-ky-ngay" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đăng ký ngay</a>
            </li>
            ...
            <li><a href="index.php?page=cam-nhan" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Cảm nhận</a>
            </li>
