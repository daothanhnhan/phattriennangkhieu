        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// dang ky online //////////
                    case "dang-ky-online":
                        include_once("template/dang-ky-online.php");
                        break;
                    case "dang-ky-ngay":
                        include_once("template/dang-ky-nhanh.php");
                        break;
                    ///////////// giảng viên //////////////
                    case "giang-vien":
                        include_once("template/teacher/teacher.php");
                        break;
                    case "them-giang-vien":
                        include_once("template/teacher/teacher-add.php");
                        break;
                    case "sua-giang-vien":
                        include_once("template/teacher/teacher-edit.php");
                        break;
                    case "xoa-giang-vien":
                        include_once("template/teacher/teacher-del.php");
                        break;
                    case "lich-giang-vien":
                        include_once("template/teacher/lich.php");
                        break;
                    /////////////// video ////////////////
                    case "video":
