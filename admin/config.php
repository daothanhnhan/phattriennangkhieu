                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
							            ...
							            <p class="titleRightNCP">Giời làm việc 1</p>
							            ...
							            <p class="titleRightNCP">Giời làm việc 2</p>
                                        ...
                                        <textarea name="lang[<?= $lang['languages_code']?>][lang_content_home9]" id="input" class="form-control" rows="3"><?= $rowDetailLang['lang_content_home9'];?></textarea>
                                    </div>
                                <?php
                                }
                            ?>
...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Ngày đếm ngược</span>
            <p class="subLeftNCP">Thay ngày cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <p class="titleRightNCP">Ngày</p>
            <input type="date" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home10']?>" name="content_home10"/>
        </div>
    </div>
    <!--end rowNodeContentPage-->
