   ...
   //          }
	...
	/*----------------- Trang nội dung -------------------*/
		...
		public function deletePage(){
			...
			if ($page_id == 42 || $page_id == 43 || $page_id == 44 || $page_id == 41 || $page_id == 46 || $page_id == 47 || $page_id == 48 || $page_id == 49 || $page_id == 50 || $page_id == 51 || $page_id == 52 || $page_id == 53 || $page_id == 54 || $page_id == 55 || $page_id == 56 || $page_id == 57 || $page_id == 58 || $page_id == 59 || $page_id == 60 || $page_id == 61 || $page_id == 62 || $page_id == 63 || $page_id == 64 || $page_id == 65 || $page_id == 66) {
				echo json_encode(array('error'=>'Mục này không được xóa.'));die;
			}
	...
	/*------------------ Tin tức -------------------*/
	    ...
	    public function deleteNews(){
			...
			if ($news_id == 106 || $news_id == 107 || $news_id == 108 || $news_id == 109) {
				echo json_encode(array('error'=>'Mục này không được xóa.'));die;
			}
...
/*---------------- Danh mục dịch vụ --------------------*/
	...
	/*------------------ dịch vụ -------------------*/
		...
		public function addService(){
			...
			$service_sub_infor1 = isset($_POST['service_sub_infor1']) ? $_POST['service_sub_infor1'] : '';

			$service_sub_infor2 = isset($_POST['service_sub_infor2']) ? $_POST['service_sub_infor2'] : '';

			$service_sub_infor3 = isset($_POST['service_sub_infor3']) ? $_POST['service_sub_infor3'] : '';

			$service_sub_infor4 = isset($_POST['service_sub_infor4']) ? $_POST['service_sub_infor4'] : '';

			$service_sub_infor5 = isset($_POST['service_sub_infor5']) ? $_POST['service_sub_infor5'] : '';
	    ...
	    public function deleteService(){
			...
			if ($service_id == 70 || $service_id == 69 || $service_id == 68 || $service_id == 67 || $service_id == 66 || $service_id == 65) {
				echo json_encode(array('error'=>'Mục này không được xóa.'));die;
			}
